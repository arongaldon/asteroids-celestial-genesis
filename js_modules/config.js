export const ASTEROIDS = 1000;
export const ASTEROIDS_INIT_INNER = 20000;
export const ASTEROIDS_INIT_OUTER = 40000;
...
export const PLANETS_LIMIT = 12;
export const PLANET_MAX_SIZE = ASTEROID_MAX_SIZE * 4;
export const PLANET_THRESHOLD = ASTEROID_MAX_SIZE * 2;
...
export const ZOOM_LEVELS = [1000, 2000, 3000, 5000, 8000, 13000, 21000];
