...
function newPlayerShip() {
    ...
    return {
        ...
        squadId: null,
        squadSlots: [
            { role: 'wingman', x: -120, y: -120, occupant: null }, { role: 'wingman', x: 120, y: -120, occupant: null },
            { role: 'wingman', x: -240, y: -240, occupant: null }, { role: 'wingman', x: 240, y: -240, occupant: null },
            { role: 'wingman', x: -360, y: -360, occupant: null }, { role: 'wingman', x: 360, y: -360, occupant: null },
            { role: 'wingman', x: 0, y: -480, occupant: null } // 7th slot
        ],
...
function createAsteroid(x, y, r, z = 0) {
    let isPlanet = r > ASTEROID_MAX_SIZE;
    let roid = {
