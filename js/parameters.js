/* ==========
   ...
   ==========*/
const ASTEROIDS = 900;
const ASTEROIDS_INIT_INNER = 1900;
const ASTEROIDS_INIT_OUTER = 19000;
const ASTEROID_DESTROYED_REWARD = 100;
const ASTEROID_MAX_SIZE = 170;
const ASTEROID_MIN_SIZE = ASTEROID_MAX_SIZE / 3;
const ASTEROID_SPEED_LIMIT = 20;
const ASTEROID_SPLIT_OFFSET = 120;
...
const SHIP_EVOLUTION_SCORE_STEP = 1 * ASTEROID_DESTROYED_REWARD; // Tier ship power improvement
